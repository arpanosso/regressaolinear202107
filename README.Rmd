...
Vamos criar o filtro para os pontos pertencentes ao polígono do Brasil, demais regiões e da amazônia legal. Devemos salientar que esses dados estão com a tendência de aumento ao longo do tempo, posteriormete vamos salvar o arquivo para posterior disponibilização.
